    ...
    <div className="min-h-screen flex items-center justify-center bg-[#e7f3ea] py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          ...
          <button
            type="button"
            className="w-full py-3 border-2 border-gray-300 rounded-lg font-semibold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition flex items-center justify-center gap-2"
          >
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="text-[#265b37] hover:text-[#1b4332] font-medium">
              Log in
            </Link>
          </p>
        </div>
